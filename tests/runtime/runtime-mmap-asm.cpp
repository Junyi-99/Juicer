...
uint8_t code[] = {0x55, 0x48, 0x89, 0xe5, 0x89, 0x7d, 0xfc, 0x48,
...
int main(int argc, char **argv) {
    ...
    __builtin___clear_cache(buf, (char *) buf + sizeof(code) -
                                 1);  // on x86 this just stops memcpy from optimizing away as a dead store
